    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_cuenta', models.CharField(choices=[('AHORROS', 'Ahorros'), ('CORRIENTE', 'Corriente'), ('CDT', 'CDT')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_transaccion', models.CharField(choices=[('CONSIGNACION', 'Consignación'), ('RETIRO', 'Retiro')], max_length=12)),
